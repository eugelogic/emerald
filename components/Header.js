...
const Header = () => {
    return (
        <header className={styles.header}>
            <div className={`${styles.box} ${styles.tl}`}>
            ...
            <div className={`${styles.box} ${styles.bl}`}>
            ...
            <div className={styles.textBox}>
                <Link href="/">
                    <a aria-label="Go Home">
                        <span className={styles.siteTitle}>Eugene Molari</span>
                        <span className={styles.siteDescription}>Product Designer</span>
                    </a>
                </Link>
            </div>
            <div className={`${styles.box} ${styles.tr}`}>
                <Link href="/menu">
                    <a>
                        ME
                        <br />
            ...
            <div className={`${styles.box} ${styles.br}`}>
